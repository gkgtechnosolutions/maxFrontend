...
@Component({
  selector: 'app-sup-dtable',
  templateUrl: './sup-dtable.component.html',
  styleUrl: './sup-dtable.component.scss'
})
export class SupDtableComponent {
  searchText;
...
gettotaldata() {
  ...
  if (this.dataSource === "Deposit") {
    dataSubscription = this.supADeposit.getAllDepositdata( this.size, this.page);
  } else if (this.dataSource === "Withdraw") {
    dataSubscription = this.supADeposit.getAllWithdrawdata( this.size, this.page);
  }
...
getRangedata() {
  ...
  this.range.valueChanges.subscribe(values => {
    ...
    if(this.searchText){
      ...
      let dataSubscription;
      if (this.dataSource === "Deposit") {
        dataSubscription = this.supADeposit.getDateDepositdata(this.StartDate, this.EndDate, this.size, this.page);
      } else if (this.dataSource === "Withdraw") {
        dataSubscription = this.supADeposit.getDateWithdrawdata(this.StartDate, this.EndDate, this.size, this.page);
      }
...
console.log('Start Date (IST):', this.StartDate);
  ...
  if (this.dataSource === "Deposit") {
    ...
    dataSubscription = this.supADeposit.getDateWithdrawdata(this.EndDate, this.StartDate, this.size, this.page);
  }
