...
@Component({
  selector: 'app-with-dailog',
  templateUrl: './with-dailog.component.html',
  styleUrl: './with-dailog.component.scss'
})
export class WithDailogComponent  implements OnInit, OnDestroy {
    formGroup: FormGroup;
